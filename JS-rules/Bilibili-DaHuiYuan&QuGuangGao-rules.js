...
bili-json = type=http-response,pattern=^https:\/\/app\.bilibili\.com\/x\/(v2\/(splash\/(list|show)|feed\/index\?)|resource\/show\/tab\/v2),script-path=https://raw.githubusercontent.com/githubwisdom/My-Quantumult-X/main/JS-file/Bilibili-json.js, requires-body=true, timeout=10
